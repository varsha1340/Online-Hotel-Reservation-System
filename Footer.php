...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo4.jpg"width="200px"height="50px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Rudraksh Apartments Sector A,Indore</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>varsha.hotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 9876543210</p><br><br><br>
     </div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develope By Varsha Patidar@ | All Rights Reserved 2020</p>
</footer>
